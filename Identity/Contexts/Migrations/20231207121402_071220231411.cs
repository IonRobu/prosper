...
{
    /// <inheritdoc />
    public partial class _071220231411 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AspNetUserPreferences", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "AspNetWorkspaces",
                columns: table => new
                {
                    Id = table.Column<long>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AspNetWorkspaces", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                name: "AspNetUserNotificationSubscriptions",
                columns: table => new
                {
                    Id = table.Column<long>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AspNetUserNotificationSubs~", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AspNetUserNotificationSubs~",
                        column: x => x.NotificationId,
                        principalTable: "AspNetUserNotifications",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrentLanguage = table.Column<string>(type: "TEXT", maxLength: 10, nullable: true),
                    LogoContent = table.Column<byte[]>(type: "BLOB", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AspNetUsers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AspNetUsers_AspNetWorkspac~",
                        column: x => x.WorkspaceId,
                        principalTable: "AspNetWorkspaces",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUserNotificationSubs~",
                table: "AspNetUserNotificationSubscriptions",
