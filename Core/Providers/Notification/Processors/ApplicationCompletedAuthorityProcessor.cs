...
public class ApplicationCompletedAuthorityProcessor : NotificationProcessor<ApplicationCompletedAuthorityEvent, UserModel>
{
	private readonly AppSettings _appSettings;

	public ApplicationCompletedAuthorityProcessor(
	...
	protected override async Task<List<UserModel>> GetUsersAsync(ApplicationCompletedAuthorityEvent source)
	{
	...
	protected override object GetTitle(ApplicationCompletedAuthorityEvent source, UserModel user)
	{
		return new
		{
	...
	protected override object GetBody(ApplicationCompletedAuthorityEvent source, UserModel user)
	{
