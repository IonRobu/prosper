...
public class ApplicationCompletedSolicitantProcessor : NotificationProcessor<ApplicationCompletedSolicitantEvent, UserModel>
{
	private readonly AppSettings _appSettings;

	public ApplicationCompletedSolicitantProcessor(
	...
	protected override async Task<List<UserModel>> GetUsersAsync(ApplicationCompletedSolicitantEvent source)
	{
	...
	protected override object GetTitle(ApplicationCompletedSolicitantEvent source, UserModel user)
	{
		return new
		{
	...
	protected override object GetBody(ApplicationCompletedSolicitantEvent source, UserModel user)
	{
