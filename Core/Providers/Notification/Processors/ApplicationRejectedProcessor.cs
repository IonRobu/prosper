...
public class ApplicationRejectedProcessor : NotificationProcessor<ApplicationRejectedEvent, UserModel>
{
	private readonly AppSettings _appSettings;

	public ApplicationRejectedProcessor(
	...
	protected override async Task<List<UserModel>> GetUsersAsync(ApplicationRejectedEvent source)
	{
	...
	protected override object GetTitle(ApplicationRejectedEvent source, UserModel user)
	{
		return new
		{
	...
	protected override object GetBody(ApplicationRejectedEvent source, UserModel user)
	{
