...
public class I18n : II18n
{
	...
	private readonly Lazy<LocalDocumentTemplate> _documentTemplate;
	public LocalDocumentTemplate DocumentTemplate => _documentTemplate.Value;
	...
	public I18n(I18nProvider i18nProvider)
	{
		...
		_documentTemplate = new Lazy<LocalDocumentTemplate>(() => _i18nProvider.GetTable<LocalDocumentTemplate>(), true);
	}
